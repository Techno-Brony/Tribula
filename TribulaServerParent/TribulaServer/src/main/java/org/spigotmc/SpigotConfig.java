...
public class SpigotConfig
{
    ...
    private static void nettyThreads()
    {
        ...
        // Bukkit.getLogger().log( Level.INFO, "Using {0} threads for Netty based IO", count );  <-- Log not required
    }
    ...
    private static void playerSample()
    {
        ...
        // System.out.println( "Server Ping Player Sample Count: " + playerSample );  <-- Log not required
    }
    ...
    private static void debug()
    {
        ...
        {
            // Bukkit.getLogger().info( "Debug logging is disabled" );  <-- Log not required
        }
    }
