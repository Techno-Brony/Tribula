...
public class ContainerBrewingStand extends Container {
    ...
    public ContainerBrewingStand(PlayerInventory playerinventory, IInventory iinventory) {
        ...
        this.a(new SlotPotionBottle(playerinventory.player, iinventory, 0, 56, 51));
        this.a(new SlotPotionBottle(playerinventory.player, iinventory, 1, 79, 58));
        this.a(new SlotPotionBottle(playerinventory.player, iinventory, 2, 102, 51));
