...
//        return true; // CraftBukkit
            ...
            if (!entity.t(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (this.isSprinting() && flag) {
                        this.world.a(null, this.locX, this.locY, this.locZ, SoundEffects.ed, this.bC(), 1.0F, 1.0F);
                        ++i;
                        flag1 = true;
                    }
                    ...
                    if (flag5) {
                        ...
                        if (flag3) {
                            ...
                            this.world.a(null, this.locX, this.locY, this.locZ, SoundEffects.eg, this.bC(), 1.0F, 1.0F);
                            this.cM();
                        }
                        ...
                        if (flag2) {
                            this.world.a(null, this.locX, this.locY, this.locZ, SoundEffects.ENTITY_PLAYER_ATTACK_CRIT, this.bC(), 1.0F, 1.0F);
                            this.a(entity);
                        }

                        if (!flag2 && !flag3) {
                            if (flag) {
                                this.world.a(null, this.locX, this.locY, this.locZ, SoundEffects.ef, this.bC(), 1.0F, 1.0F);
                            } else {
                                this.world.a(null, this.locX, this.locY, this.locZ, SoundEffects.eh, this.bC(), 1.0F, 1.0F);
                            }
                        }
                        ...
                        if (itemstack3 != null && object instanceof EntityLiving) {
                            ...
                            if (itemstack3.count == 0) {
                                this.a(EnumHand.MAIN_HAND, null);
                            }
                        }
                        ...
                        this.world.a(null, this.locX, this.locY, this.locZ, SoundEffects.ee, this.bC(), 1.0F, 1.0F);
                        if (flag4) {
                            entity.extinguish();
                        }
                    }
    ...
    public void b(EntityLiving entityliving) {
        ...
        EntityTypes.MonsterEggInfo entitytypes_monsteregginfo = EntityTypes.eggInfo.get(EntityTypes.b(entityliving));
    ...
    public void levelDown(int i) {
        ...
        if (i > 0 && this.expLevel % 5 == 0 && (float) this.bS < (float) this.ticksLived - 100.0F) {
            ...
            this.world.a(null, this.locX, this.locY, this.locZ, SoundEffects.en, this.bC(), f * 0.75F, 1.0F);
