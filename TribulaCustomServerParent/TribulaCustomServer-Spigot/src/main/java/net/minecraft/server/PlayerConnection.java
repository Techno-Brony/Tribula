    ...
    public void a(PacketPlayInVehicleMove packetplayinvehiclemove) {
        ...
        if (b(packetplayinvehiclemove)) {
            ...
            if (entity != this.player && entity.bw() == this.player && entity == this.r) {
                ...
                if (d10 - d9 > Math.max(100, Math.pow(org.spigotmc.SpigotConfig.movedTooQuicklyMultiplier * (float) i * speed, 2)) && (!this.minecraftServer.R() || !this.minecraftServer.Q().equals(entity.getName()))) { // Spigot
                // CraftBukkit end
                    PlayerConnection.LOGGER.warn("{} (vehicle of {}) moved too quickly! {},{},{}", entity.getName(), this.player.getName(), d6, d7, d8);
                ...
                if (this.teleportPos != null) {
                    ...
                    if (this.player.isPassenger()) {
                        ...
                        if (!this.player.K() && (!this.player.x().getGameRules().getBoolean("disableElytraMovementCheck") || !this.player.cG())) {
                            ...
                            if (d11 - d10 > Math.max(100, Math.pow(org.spigotmc.SpigotConfig.movedTooQuicklyMultiplier * (float) i * speed, 2)) && (!this.minecraftServer.R() || !this.minecraftServer.Q().equals(this.player.getName()))) { // Spigot
                        // CraftBukkit end
                                PlayerConnection.LOGGER.warn("{} moved too quickly! {},{},{}", this.player.getName(), d7, d8, d9);
    ...
    public void a(PacketPlayInEntityAction packetplayinentityaction) {
        ...
        case 8:
            if (this.player.bB() instanceof EntityHorse) {
                ((EntityHorse) this.player.bB()).f(this.player);
            }
            break;
        ...
        if (entity != null) {
            ...
            if (this.player.h(entity) < d0) {
                ...
                if (packetplayinuseentity.a() == PacketPlayInUseEntity.EnumEntityUseAction.INTERACT) {
                    ...
                    enumhand = packetplayinuseentity.b();
                    itemstack = this.player.b(enumhand);
                    entity.a(this.player, packetplayinuseentity.c(), itemstack, enumhand);
    ...
    public void a(PacketPlayInWindowClick packetplayinwindowclick) {
        ...
        if (this.player.activeContainer.windowId == packetplayinwindowclick.a() && this.player.activeContainer.c(this.player)) {
            ...
            if (ItemStack.matches(packetplayinwindowclick.e(), itemstack)) {
                ...
                this.k.a(this.player.activeContainer.windowId, packetplayinwindowclick.d());
                    ...
                    try {
                        ...
                        if (commandblocklistenerabstract1 != null) {
                            ...
                            case 1:
                                ...
                                this.player.world.setTypeAndData(blockposition, iblockdata.set(BlockCommand.a, enumdirection).set(BlockCommand.b, flag2), 2);
                                break;
                            ...
                            if (tileentity instanceof TileEntityStructure) {
                                ...
                                if (b1 == 2) {
                                    if (tileentitystructure.q()) {
                                        this.player.b(new ChatMessage("structure_block.save_success", s7));
                                    } else {
                                        this.player.b(new ChatMessage("structure_block.save_failure", s7));
                                    }
                                } else if (b1 == 3) {
                                    if (!tileentitystructure.F()) {
                                        this.player.b(new ChatMessage("structure_block.load_not_found", s7));
                                    } else if (tileentitystructure.r()) {
                                        this.player.b(new ChatMessage("structure_block.load_success", s7));
                                    } else {
                                        this.player.b(new ChatMessage("structure_block.load_prepare", s7));
                                    }
                                } else if (b1 == 4) {
                                    if (tileentitystructure.p()) {
                                        this.player.b(new ChatMessage("structure_block.size_success", s7));
                                    } else {
                                        this.player.b(new ChatMessage("structure_block.size_failure"));
                                    }
                                }
