...
public class LoginListener implements PacketLoginInListener, ITickable {
    ...
    public void a(IChatBaseComponent ichatbasecomponent) {
        LoginListener.c.info("{} lost connection: {}", this.d(), ichatbasecomponent.toPlainText());
    }
            ...
            (new Thread("User Authenticator #" + LoginListener.b.incrementAndGet()) {
                public void run() {
                    ...
                    try {
                        ...
                        LoginListener.this.i = LoginListener.this.server.ay().hasJoinedServer(new GameProfile(null, gameprofile.getName()), s);
