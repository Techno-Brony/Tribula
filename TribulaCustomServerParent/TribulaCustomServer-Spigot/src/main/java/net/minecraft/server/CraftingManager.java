...
public class CraftingManager {
    ...
    public CraftingManager() {
        ...
        this.registerShapedRecipe(new ItemStack(Blocks.STONE_SLAB, 6, BlockDoubleStepAbstract.EnumStoneSlabVariant.STONE.a()), "###", '#', new ItemStack(Blocks.STONE, 1, BlockStone.EnumStoneVariant.STONE.a()));
        ...
        this.registerShapedRecipe(new ItemStack(Items.aG, 1), "# #", "###", '#', new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.OAK.a()));
        this.registerShapedRecipe(new ItemStack(Items.aH, 1), "# #", "###", '#', new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.SPRUCE.a()));
        this.registerShapedRecipe(new ItemStack(Items.aI, 1), "# #", "###", '#', new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.BIRCH.a()));
        this.registerShapedRecipe(new ItemStack(Items.aJ, 1), "# #", "###", '#', new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.JUNGLE.a()));
        this.registerShapedRecipe(new ItemStack(Items.aK, 1), "# #", "###", '#', new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.ACACIA.a()));
        this.registerShapedRecipe(new ItemStack(Items.aL, 1), "# #", "###", '#', new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.DARK_OAK.a()));
        ...
        this.registerShapedRecipe(new ItemStack(Items.cP), "GGG", "GEG", "GTG", 'G', Blocks.GLASS, 'E', Items.ENDER_EYE, 'T', Items.GHAST_TEAR);
        ...
        this.registerShapedRecipe(new ItemStack(Blocks.di, 1), "XXX", "XXX", "XXX", 'X', new ItemStack(Items.DYE, 1, EnumColor.WHITE.getInvColorIndex()));
        sort();
    }
    ...
    public ShapedRecipes registerShapedRecipe(ItemStack itemstack, Object... aobject) {
        ...
        for (l = 0; l < j * k; ++l) {
            ...
            if (hashmap.containsKey(c0)) {
                aitemstack[l] = ((ItemStack) hashmap.get(c0)).cloneItemStack();
            } else {
                aitemstack[l] = null;
            }
        }
