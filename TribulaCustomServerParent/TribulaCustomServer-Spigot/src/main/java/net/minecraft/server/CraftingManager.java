...
public class CraftingManager {
    ...
    public CraftingManager() {
        ...
        this.registerShapedRecipe(new ItemStack(Blocks.STONE_SLAB, 6, BlockDoubleStepAbstract.EnumStoneSlabVariant.STONE.a()), "###", Character.valueOf('#'), new ItemStack(Blocks.STONE, 1, BlockStone.EnumStoneVariant.STONE.a()));
        ...
        this.registerShapedRecipe(new ItemStack(Items.aG, 1), "# #", "###", Character.valueOf('#'), new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.OAK.a()));
        this.registerShapedRecipe(new ItemStack(Items.aH, 1), "# #", "###", Character.valueOf('#'), new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.SPRUCE.a()));
        this.registerShapedRecipe(new ItemStack(Items.aI, 1), "# #", "###", Character.valueOf('#'), new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.BIRCH.a()));
        this.registerShapedRecipe(new ItemStack(Items.aJ, 1), "# #", "###", Character.valueOf('#'), new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.JUNGLE.a()));
        this.registerShapedRecipe(new ItemStack(Items.aK, 1), "# #", "###", Character.valueOf('#'), new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.ACACIA.a()));
        this.registerShapedRecipe(new ItemStack(Items.aL, 1), "# #", "###", Character.valueOf('#'), new ItemStack(Blocks.PLANKS, 1, BlockWood.EnumLogVariant.DARK_OAK.a()));
        ...
        this.registerShapedRecipe(new ItemStack(Items.GOLDEN_CARROT), "###", "#X#", "###", Character.valueOf('#'), Items.GOLD_NUGGET, Character.valueOf('X'), Items.CARROT);
        ...
        this.registerShapedRecipe(new ItemStack(Items.cP), "GGG", "GEG", "GTG", Character.valueOf('G'), Blocks.GLASS, Character.valueOf('E'), Items.ENDER_EYE, Character.valueOf('T'), Items.GHAST_TEAR);
        ...
        this.registerShapedRecipe(new ItemStack(Blocks.END_ROD, 4), "/", "#", Character.valueOf('/'), Items.BLAZE_ROD, Character.valueOf('#'), Items.CHORUS_FRUIT_POPPED);
        this.registerShapedRecipe(new ItemStack(Blocks.di, 1), "XXX", "XXX", "XXX", Character.valueOf('X'), new ItemStack(Items.DYE, 1, EnumColor.WHITE.getInvColorIndex()));
        sort();
    }
