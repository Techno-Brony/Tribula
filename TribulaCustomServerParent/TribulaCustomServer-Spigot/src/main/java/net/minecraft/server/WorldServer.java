...
public class WorldServer extends World implements IAsyncTaskHandler {
    ...
    protected void l() {
        ...
        for (EntityHuman player : this.players) {
            Entity entity1 = player.bB();

            if (entity1 != null) {
                if (!entity1.dead && entity1.w(player)) {
                    continue;
                }
            ...
            if (!player.dead) {
                try {
                    ...
                    player.appendEntityCrashDetails(crashreportsystemdetails);
            ...
            if (player.dead) {
                ...
                if (player.ab && this.isChunkLoaded(j, k, true)) {
                    this.getChunkAt(j, k).b(player);
                }
    ...
    public boolean addEntity(Entity entity, SpawnReason spawnReason) { // Changed signature, added SpawnReason
        ...
        return this.i(entity) && super.addEntity(entity, spawnReason);
    }
    // CraftBukkit end
    ...
    public boolean strikeLightning(Entity entity) {
        ...
        if (super.strikeLightning(entity)) {
            this.server.getPlayerList().sendPacketNearby(null, entity.locX, entity.locY, entity.locZ, 512.0D, dimension, new PacketPlayOutSpawnEntityWeather(entity)); // CraftBukkit - Use dimension
            return true;
        } else {
            return false;
        }
        ...
        while (!this.S[this.T].isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (this.a(blockactiondata)) {
                    ...
                    this.server.getPlayerList().sendPacketNearby(null, (double) blockactiondata.a().getX(), (double) blockactiondata.a().getY(), (double) blockactiondata.a().getZ(), 64.0D, dimension, new PacketPlayOutBlockAction(blockactiondata.a(), blockactiondata.d(), blockactiondata.b(), blockactiondata.c()));
                }
            }
