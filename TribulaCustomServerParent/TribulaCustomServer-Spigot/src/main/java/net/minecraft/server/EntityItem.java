    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide) {
            ...
            if (this.pickupDelay == 0 && (this.h == null || 6000 - this.age <= 200 || this.h.equals(entityhuman.getName())) && entityhuman.inventory.pickup(itemstack)) {
                ...
                if (!this.isSilent()) {
                    this.world.a(null, entityhuman.locX, entityhuman.locY, entityhuman.locZ, SoundEffects.da, SoundCategory.PLAYERS, 0.2F, ((this.random.nextFloat() - this.random.nextFloat()) * 0.7F + 1.0F) * 2.0F);
                }
