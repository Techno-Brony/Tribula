...
public class TileEntityChest extends TileEntityLootable implements ITickable, IInventory {
    ...
    public void E_() {
        ...
        if (this.l > 0 && this.j == 0.0F && this.f == null && this.h == null) {
            ...
            this.world.a(null, d1, (double) j + 0.5D, d0, SoundEffects.X, SoundCategory.BLOCKS, 0.5F, this.world.random.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.l == 0 && this.j > 0.0F || this.l > 0 && this.j < 1.0F) {
            ...
            if (this.j < 0.5F && f1 >= 0.5F && this.f == null && this.h == null) {
                ...
                this.world.a(null, d0, (double) j + 0.5D, d2, SoundEffects.V, SoundCategory.BLOCKS, 0.5F, this.world.random.nextFloat() * 0.1F + 0.9F);
            }
