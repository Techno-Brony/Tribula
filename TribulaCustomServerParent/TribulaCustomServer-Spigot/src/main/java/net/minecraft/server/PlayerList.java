...
public abstract class PlayerList {
    ...
    public NBTTagCompound a(EntityPlayer entityplayer) {
        ...
        if (entityplayer.getName().equals(this.server.Q()) && nbttagcompound != null) {
            nbttagcompound1 = this.server.getDataConverterManager().a(DataConverterTypes.PLAYER, nbttagcompound);
    ...
    public EntityPlayer moveToWorld(EntityPlayer entityplayer, int i, boolean flag, Location location, boolean avoidSuffocation) {
        ...
        worldserver.getChunkProviderServer().getChunkAt((int) entityplayer.locX >> 4, (int) entityplayer.locZ >> 4);
